...
\end{align}
where the last step is derived in appendix~\ref{Appendix:LRbases}. \textcolor{red}{These relationships indicate the Faraday effect is generated by the phase difference between the right- and left-polarized modes or by the photon number or intensity difference between two linearly polarized modes due to the polarizability of the atoms.}
