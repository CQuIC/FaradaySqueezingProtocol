...
\newcommand{\SWG}{SWG\xspace}%{square waveguide\xspace}
...
C_1(\mbf{r}'_\perp) &= n_g\frac{\sigma_0}{2f^2}\frac{ \left\vert \mathrm{Re}\! \left[ \mbf{u}^*_V (\mbf{r}'_\perp) \times \mbf{u}_H (\mbf{r}'_\perp) \right]\right\vert^2}{\vert \mbf{u}_H (\mbf{r}'_\perp) \vert ^2}\nn\\ &\le n_g  \frac{\sigma_0}{2f^2} \vert \mbf{u}_V (\mbf{r}'_\perp) \vert ^2.
\end{align}
