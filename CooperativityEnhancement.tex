...
\centering
  ...
  \begin{minipage}[bt]{.5\textwidth}
      \centering
      \includegraphics[width=.44\textwidth]{fig/poincaresphere_initialS1_crystal}
      \label{fig:poincaresphere_initialS1_crystal}
   \hfill
        \centering
        \includegraphics[width=.44\textwidth]{fig/poincaresphere_initialS1_Faradayrot_crystal}
        \label{fig:poincaresphere_initialS1_Faradayrot_crystal}
   \vfill
    \centering
    \includegraphics[width=.44\textwidth]{fig/blochsphere_initialxFxyz_crystal_orange}
...
\begin{align}
C_1(\mbf{r}'_\perp) &= \sigma_0\frac{n_g \left\vert \text{Re}\! \left[ \mbf{u}^*_V (\mbf{r}'_\perp) \times \mbf{u}_H (\mbf{r}'_\perp) \right]\right\vert^2}{\vert \mbf{u}_H (\mbf{r}'_\perp) \vert ^2}\nn\\
&\le \sigma_0n_g \vert \mbf{u}_V (\mbf{r}'_\perp) \vert ^2.\label{eq:c1_bound}
\end{align}
...
\centering
 ...
 %\begin{tabular}{*{2}{b{0.2\textwidth-2\tabcolsep}}}
  \subfloat[h][$\xi^{-2}_{nanofiber}(t)$]{
    ...
    \includegraphics[width=0.49\linewidth]{fig/autofig/FaradayProtocol-figure6}
   ...
   \begin{minipage}[h]{0.99\linewidth}
    %\begin{tabular}{*{2}{b{0.2\textwidth-2\tabcolsep}}}
     \subfloat[h][$\xi^{-2}_{swg}(t)$]{
       ...
       \includegraphics[width=0.49\linewidth]{fig/autofig/FaradayProtocol-figure8}
...
\centering
 ...
 %\begin{tabular}{*{2}{b{0.2\textwidth-2\tabcolsep}}}
  \subfloat[h][$ \Gamma_{\rm nanofiber}/\Gamma_0 $]{
    ...
    \includegraphics[width=0.85\linewidth]{fig/autofig/FaradayProtocol-Figure14}
   ...
   \begin{minipage}[h]{0.9\linewidth}
    %\begin{tabular}{*{2}{b{0.2\textwidth-2\tabcolsep}}}
     \subfloat[h][$\Gamma_{\rm SWG}/\Gamma_0$]{
       ...
       \includegraphics[width=0.85\linewidth]{fig/autofig/FaradayProtocol-Figure15}
