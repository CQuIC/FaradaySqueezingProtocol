...
\end{align}
The first term on the right-hand side of Eq.\eqref{eq:totaldrhodt} gives rise to the collective spin dynamics due to QND measurement,
\begin{align}
...
\end{align}
where  $\kappa$ is the measurement strength defined in Eq. (?), and $\mathrm{d}W$ is a stochastic Weiner interval satisfying $\mathrm{d}W^2 = \mathrm{d}t$. The conditional dynamics induced by the QND measurement and generated by the superoperators that depend on the collective spin
\begin{subequations}
\begin{align}
