...
\centering
 ...
 %\begin{tabular}{*{2}{b{0.2\textwidth-2\tabcolsep}}}
  ...
  \subfloat[h][$ 1/\Ain $]{
   ...
   \end{minipage}
   %\end{tabular}
\caption{Contour plots of the effective mode areas and the cooperativity per atom near a SWG. Subfigs.~\protect\subref*{fig:swg_invAFarxy} and~\protect\subref*{fig:swg_invAin_xy} show the contour of the inversed effective Faraday interaction mode area and the inversed input mode area in the $ xy $-plane, respectively. An $ x $-polarized incident mode is assumed. Subfig.~\protect\subref*{fig:swg_C1_xy} shows the cooperativity contour plot in the $ xy $-plane. The isovalue lines of $ C_1 $ raise up by $ 0.1611 $ on each step from the outside inwards.}\label{fig:swg_Aeffgeometry}
\end{figure}
