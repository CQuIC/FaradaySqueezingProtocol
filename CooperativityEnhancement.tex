...
We thank Poul Jessen for encouraging and insightful discussions on pursuing this research direction.
...
If only keeping coherence operators of the nearest coupling states, Eqs.~\eqref{eq:dsigmaba_op_expand} and~\eqref{eq:dsigmabadc_op_expand} regress to Norris' result~\cite{Norris2014}.
