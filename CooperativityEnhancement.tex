...
\centering
  ...
  \begin{minipage}[bt]{.88\textwidth}
    ...
    \end{minipage} }\\
  %\end{subfloat}\\%   
  \subfloat[b][Evolution of the light and collective spins]{
  ...
  \end{minipage}}\hfill
  %\end{subfloat}% 
  \subfloat[b][Internal state transitions with a $ \pi $-pumping ]{
  \begin{minipage}[bt]{.45\textwidth}
    ...
    \end{minipage}}
    %\end{subfloat}
  \caption{This figure shows the schematic diagram of the QND measurement and spin squeezing setup based on our Faraday protocol discussed in this paper.  }\label{fig:spinsqueezingschematic}
\end{figure}
