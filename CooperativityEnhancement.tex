...
%===============Appendix================= %
\begin{appendix}
\section{Photon scattering and optical pumping rates}
In this Appendix, we will generalize the stochastic equations and optical pumping rates outlined in Refs.~\cite{Deutsch2010a} and ~\cite{Qi2016} to the Faraday protocol discussed in this paper in the rotating frame. 
