...
\centering
 ...
 %\begin{tabular}{*{2}{b{0.2\textwidth-2\tabcolsep}}}
  \subfloat[h][$1/\AF$]{
    ...
    \includegraphics{fig/autofig/FaradayProtocol-figure0_1}
    \label{fig:nanofiber_invAFarxy}
    }
    \hfill
  \subfloat[h][$ 1/\Ain $]{
      \label{fig:nanofiber_invAin_xy}
      \includegraphics{fig/autofig/FaradayProtocol-figure1_1}
   ...
   \subfloat[h][$ C_1 $]{
      ...
      \includegraphics{fig/autofig/FaradayProtocol-figure2_1}
...
\centering
 ...
 %\begin{tabular}{*{2}{b{0.2\textwidth-2\tabcolsep}}}
  \subfloat[h][$1/\AF$]{
    ...
    \includegraphics{fig/autofig/FaradayProtocol-figure3_1}
    \label{fig:square waveguide_invAFarxy}
    }
    \hfill
  \subfloat[h][$ 1/\Ain $]{
      \label{fig:square waveguide_invAin_xy}
      \includegraphics{fig/autofig/FaradayProtocol-figure4_1}
   ...
   \subfloat[h][$ C_1 $]{
      ...
      \includegraphics{fig/autofig/FaradayProtocol-figure5_1}
