...
\begin{align}
\hat{\chi}_{i3} &= \hat{\chi}_{HV}-\hat{\chi}_{VH}
\end{align}
...
This conclusion may be generalized to cylindrical waveguides at large.
...
\end{align}
where $ \chi_{33} $ is the measurement strength generating the entanglement between the collective spin state $ \hat{F}_z $ and the probe's polarization state of $ \hat{S}_3 $.
