...
\begin{align}
\chi_3(\mbf{r}'_\perp) &= -\frac{4 \pi \omega_0}{v_g} \alpha_1 \left\vert \mathrm{Re} \left[ \mbf{u}^*_V (\mbf{r}'_\perp) \times \mbf{u}_H (\mbf{r}'_\perp) \right] \right\vert\nn\\ &=\frac{1}{3f}  \frac{\sigma_0}{A_{Far}(\mbf{r}'_\perp)} \frac{\Gamma_A}{2 \Delta_{\eff}}.
\end{align}
