...
Not to be confused, we have defined an operator space spanned by operator vectors, like $ \left(\!\begin{array}{cc}\mathbf{e}_n,&\mathbf{e}_{\bar{n}}\end{array}\! \right) $, which has vectors, tensors or operators as the elements.
...
\begin{align}
\hat{S}_0 &= \frac{1}{2}\left[\left(\!\begin{array}{cc}\hat{a}_n^\dagger,& \hat{a}_{\bar{n}}^\dagger\end{array} \!\right)\bullet\mathbf{R}_{[:,1]}(\theta)\bullet\mathbf{R}^T_{[1,:]}(\theta)\bullet
\left(\!\begin{array}{c}\hat{a}_n\\ \hat{a}_{\bar{n}}\end{array} \!\right)
+ \left(\!\begin{array}{cc}\hat{a}_n^\dagger,& \hat{a}_{\bar{n}}^\dagger\end{array} \!\right)\bullet\mathbf{R}_{[:,2]}(\theta)\bullet\mathbf{R}^T_{[2,:]}(\theta)\bullet
...
\bullet\left[\mathbf{R}_{[:,1]}(\theta)\bullet\mathbf{R}^T_{[1,:]}(\theta) - \mathbf{R}_{[:,2]}(\theta)\bullet\mathbf{R}^T_{[2,:]}(\theta) \right]
...
\bullet\left[\mathbf{R}_{[:,1]}(\theta)\bullet\mathbf{R}^T_{[2,:]}(\theta) + \mathbf{R}_{[:,2]}(\theta)\bullet\mathbf{R}^T_{[1,:]}(\theta) \right]
\bullet\left(\!\begin{array}{c}\hat{a}_n\\ \hat{a}_{\bar{n}}\end{array} \!\right) \right\}\nn\\
...
\end{align}
\end{subequations}
In deriving the equations above, we have denoted $ \mathbf{R}_{[:,i]}(\theta) $ as the $ i $-th column of $ \mathbf{R}(\theta) $ and $ \mathbf{R}_{[i,:]}^T(\theta) $ as the $ i $-th row of $ \mathbf{R}^T(\theta) $.
...
\mathrm{vec}_r\left[\mathbf{R}_{[:,1]}(\theta)\mathbf{R}^T_{[1,:]}(\theta) + \mathbf{R}_{[:,2]}(\theta)\mathbf{R}^T_{[2,:]}(\theta) \right]\\
\mathrm{vec}_r\left[\mathbf{R}_{[:,1]}(\theta)\mathbf{R}^T_{[1,:]}(\theta) - \mathbf{R}_{[:,2]}(\theta)\mathbf{R}^T_{[2,:]}(\theta) \right]\\
\mathrm{vec}_r\left[\mathbf{R}_{[:,1]}(\theta)\mathbf{R}^T_{[2,:]}(\theta) + \mathbf{R}_{[:,2]}(\theta)\mathbf{R}^T_{[1,:]}(\theta) \right]\\
-i\mathrm{vec}_r\left[\mathbf{R}_{[:,1]}(\theta)\mathbf{R}^T_{[2,:]}(\theta) - \mathbf{R}_{[:,2]}(\theta)\mathbf{R}^T_{[1,:]}(\theta) \right]
 \end{array} \!\right)\\
...
\bullet\left(\!\begin{array}{c}\hat{a}_n\\ \hat{a}_{\bar{n}}\end{array} \!\right) \nn\\
&= \hbar \hat{\boldsymbol{\chi}}_{n,\bar{n}}^T\bullet \hat{\mathbf{A}}_{n,\bar{n}}= \hbar \hat{\boldsymbol{\chi}}_{n,\bar{n}}^T\bullet 2\mathbf{M}^\dagger\bullet \hat{\mathbf{S}}\\
